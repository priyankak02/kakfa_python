#Python code to pass key value pair with key & value serialization with key or value serializer explicitly mentioned
#key is serialized as simple string while, value is serialized using JSON format
